...
const components = {
    //navbar
    "navbar": `
    <div id="navbar" class="navbar" onclick="window.open('https://www.youtube.com/watch?v=gtSBzXEI7Ko', '_blank').focus();"><a href="/"><img id="bark_logo" src="/src/images/logos/normal.png" alt="Bark" title="Home" width="25" height="25""></a>
